...
const BLOCKNAME = "cta-block";
const BLOCKPATH = `customcore/${BLOCKNAME}`;
// Custom Panel Component for Item Block Inspector within CAT Block
...
registerBlockType(BLOCKPATH, {
    ...
    edit: ({ clientId }) => {
        ...
        return (
            <div className="cta-block pd-block pd-inline">
                <InspectorControls>
                    <ItemBlockInspector clientId={clientId} />
                    <PanelBody title="CTA Block Settings">
                        <p>Settings for the CTA block can be added here.</p>
                    </PanelBody>
                </InspectorControls>
                <InnerBlocks
    ...
    save: () => {
        return (
            <section className="cta-block pd-block pd-inline">
                <InnerBlocks.Content />
            </section>
        );
    },
